...
JhipsterGenerator.prototype.app = function app() {
    ...
    if (this.stormpath == 'no' && this.storage == 'mongo') {
        ...
        removefile(javaDir + 'domain/util/UserPasswordEncoderListener.java');
    }
    ...
    if (this.storage == 'mongo') {
        ...
        removefolder(javaDir + 'security/mongodb');
    }
    if (this.stormpath === 'no') {
        ...
        removefile(javaDir + 'security/UserDetailsAuthenticationProvider.java');
    }
    ...
    if (this.apiOnly === 'no') {
        ...
        spawnSync('sh', ['-c', '"cd ui && ember init ' + this.baseName + ' --skip-npm --skip-bower"']);
        spawnSync('sh', ['-c', '"cd ui && bower install bootstrap ember-addons.bs_for_ember --save"']);
        spawnSync('sh', ['-c', '"cd ui && npm install --save-dev broccoli-less-single ember-cli-simple-auth ember-cli-simple-auth-oauth2"']);
        ...
        //App folder UI files
        removefile(uiDir + 'app/router.js');
        this.template(uiDir + 'app/_router.js', uiDir + 'app/router.js');

        this.template(uiDir + 'app/templates/_navigation.hbs', uiDir + 'app/templates/navigation.hbs');
        removefile(uiDir + 'app/templates/application.hbs');
        ...
        removefile(uiDir + 'app/styles/main.css');
        ...
        this.template(uiDir + 'app/initializers/_authentication.js', uiDir + 'app/initializers/authentication.js');
        this.template(uiDir + 'app/initializers/_simple-auth-config.js', uiDir + 'app/initializers/simple-auth-config.js');
